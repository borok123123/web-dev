...
1. Clone this Project <code>git clone https://github.com/borok123123/Multi-Authors-Django-Blog.git </code>
2. Go to Project Directory <code>cd Multi-Authors-Django-Blog </code>
